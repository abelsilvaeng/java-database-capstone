...
--
-- This is the dataset provided by the "Adding Databases and Tables" lab:
-- 25 doctors, 100 availability slots, 25 patients, 135 appointments and
-- one admin account.
--
-- Run it after the application has created the tables (ddl-auto=update),
-- or after SQL/cms.sql if you prefer to create the schema by hand.
-- =====================================================================
